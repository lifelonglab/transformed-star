...
from cl_config.utils import load_config
from cl_paths import ROOT_PATH, LOGS_PATH
from scenarios.run_cl_scenario import run_scenario
...
def _configure_parser():
    ...
    parser.add_argument('--config',
                        ...
                        type=str,
                        required=False, default='cumulative_config_param.yml')
    ...
    parser.add_argument(
        "--scenario_type",
        choices=['domain_incremental'],
        default='domain_incremental'
    )
...
if __name__ == '__main__':
    ...
    if args.strategy_name == 'Replay':
        out_dir_schema = f'ICLR/{args.scenario_type}/{args.scenario}_{args.balanced}/{args.strategy_name}/' \
